...
namespace Nethermind.Evm
{
    public class TransactionProcessor : ITransactionProcessor
    {
        ...
        private void QuickFail(Transaction tx, StateUpdate block, ITxTracer txTracer, string reason)
        {
        ...
        private void Execute(Transaction transaction, StateUpdate block, ITxTracer txTracer, bool isCall)
        {
