...
namespace Nethermind.Evm.Test
{
    ...
    public class TransactionProcessorTests
    {
        ...
        public void Setup()
        {
            ...
            VirtualMachine virtualMachine = new VirtualMachine(_stateProvider, storageProvider, Substitute.For<IStateUpdateHashProvider>(), _specProvider, LimboLogs.Instance);
